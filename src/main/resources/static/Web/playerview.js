var app = new Vue({
    ...
    methods: {
        ...
        placeShips: function (locCell) {
            ...
            var shipDirection = shipInfo.slice(9); //contains horiz if horizontal
...
//            }
    ...
    rotate: function (cellId) {
        const cell = document.getElementById(cellId);
        if (cell.classList.contains('horiz')) {
            cell.classList.remove('horiz');
            cell.classList.add("vertical");
            rotationClass = 'vertical';
        }
        else{
            cell.classList.add('horiz')
            cell.classList.remove('vertical')
            rotationClass= 'horiz';
        }
        console.log(rotationClass);
        placeShips(cell.parentNode.id);
    },
